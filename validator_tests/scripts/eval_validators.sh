...
python validator_tests/eval_validators.py --exp_group_prefix mnist --run_combined
python validator_tests/eval_validators.py --exp_group_prefix office31 --run_combined
python validator_tests/eval_validators.py --exp_group_prefix officehome --run_combined
python validator_tests/eval_validators.py --exp_group_prefix domainnet126 --run_single