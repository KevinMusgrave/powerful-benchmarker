...
python simple_slurm.py --command "python validator_tests/process_df.py" --slurm_config_folder validator_tests --slurm_config mnist --job_name=process_df --cpus-per-task=2 --exp_group_excludes oracle